...
HerkuleXConstants::HerkuleXConstants()
  ...
  { "gimbal_pitch", Register{0x50, 4, 7} },
  { "gimbal_yaw", Register{0x54, 4, 7} },
  { "gimbal_imu_pitch", Register{0x58, 4, 7} },
  { "gimbal_imu_yaw", Register{0x5c, 4, 7} },
  { "gimbal_encoder_yaw", Register{0x60, 2, 7} },
